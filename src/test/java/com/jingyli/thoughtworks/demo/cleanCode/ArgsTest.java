...
public class ArgsTest {
    @Test
    public void withLoggingEnabled() throws Exception {
    ...
    @Test
    public void withSetPort() throws Exception {
    ...
    @Test
    public void withConfiguredDirectory() throws Exception {
    ...
    @Test
    public void withLoggingEnabledSetPortAndConfiguredDirectory() throws Exception {
